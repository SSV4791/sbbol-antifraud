...
По результатам работы джобы в OpenShift создается 5 основных `Deployment`: `Ingress`, `Egress`, deployment с приложением
и два деплоймента Dataspace (Core и Gigabas).
