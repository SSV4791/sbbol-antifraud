...
public enum DboOperation {
    ...
    /**
     * Тип операции "Счет доверенного контрагента (партнера) или
     * контрагент (партнер), подлежащий удалению из справочника"
     */
    PARTNERS(null, null),

    /**
     * Тип операции "Кредит или Банковская гарантия"
     */
    CREDIT_REQ_MMB_PPRB(null, null);
