...
pipeline {
    ...
    stages {
        stage('Init') {
            steps {
                script {
                    ...
                    pullRequest = bitbucket.getPullRequest(ufsCredential, params.projectKey, params.repoSlug, params.sourcePullRequestId.toInteger())
        ...
        stage('Upstream pull request') {
            steps {
                script {
                    def commits = bitbucket.getPullRequestCommits(ufsCredential, params.projectKey, params.repoSlug, params.sourcePullRequestId)
        ...
        failure {
            script {
                try {
                    ...
                    def fields = [
                            project          : [
                                    id: jira.getProject('cab-sa-pyjobs01', bitbucket.getJiraKeyByLogin(ufsCredential, authorPr)).id
                            ],
