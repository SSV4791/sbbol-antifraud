...
public abstract class ElectronicReceiptMapper implements CommonMapper {
    ...
    @Mapping(target = "identificationData.dboOperation", ignore = true)
    ...
    @Mapping(target = "eventDataList.eventDataHeader.eventType", ignore = true)
    @Mapping(target = "eventDataList.eventDataHeader.eventDescription", ignore = true)
    @Mapping(target = "eventDataList.eventDataHeader.clientDefinedEventType", ignore = true)
    ...
    @AfterMapping
    protected void createClientDefinedAttributeList(@MappingTarget AnalyzeRequest analyzeRequest, ElectronicReceiptOperationGet paymentGet) {
    ...
    public abstract AnalyzeResponse toAnalyzeResponse(FullAnalyzeResponse dto);
