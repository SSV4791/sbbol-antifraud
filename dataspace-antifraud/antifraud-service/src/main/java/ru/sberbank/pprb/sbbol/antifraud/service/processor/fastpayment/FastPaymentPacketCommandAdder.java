 ...
 */
public final class FastPaymentPacketCommandAdder {

    private FastPaymentPacketCommandAdder() {
    }
     ...
     */
    public static RequestId addCreateCommandToPacket(Packet packet, FastPaymentOperation operation) {
     ...
     */
    public static void addUpdateCommandToPacket(Packet packet, FastPaymentOperation operation, String objectId) {
