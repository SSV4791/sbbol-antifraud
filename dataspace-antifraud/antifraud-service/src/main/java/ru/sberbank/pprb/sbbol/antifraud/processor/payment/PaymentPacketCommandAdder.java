 ...
 */
public class PaymentPacketCommandAdder {
    ...
    public static RequestId addCreateCommandToPaket(Packet packet, PaymentOperation payment) {
        ...
        packet.paymentOperation.create(param -> {
            ...
            if (payment.getDocument().getReceiver() != null) {
                ...
                param.setReceiverAccount(payment.getDocument().getReceiver().getAccount());
                param.setReceiverBicAccount(payment.getDocument().getReceiver().getBicAccount());
            }
