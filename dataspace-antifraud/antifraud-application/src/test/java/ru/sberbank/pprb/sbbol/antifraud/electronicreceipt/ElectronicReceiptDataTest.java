...
class ElectronicReceiptDataTest extends ElectronicReceiptIntegrationTest {
    ...
    void saveAndUpdateDataTest() throws Throwable {
        ...
        ElectronicReceiptOperationGet actualCreate = searchElectronicReceipt(docId);
        ...
        ElectronicReceiptOperationGet actualUpdate = searchElectronicReceipt(docId);
    ...
    private void verify(UUID requestId, UUID docId, ElectronicReceiptOperation expected, ElectronicReceiptOperationGet actual) {
