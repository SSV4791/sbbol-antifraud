...
public abstract class ElectronicReceiptMapper implements CommonMapper<ElectronicReceipt> {
    ...
    @Mapping(target = "identificationData.dboOperation", expression = "java(DboOperation.ELECTRONIC_CHEQUE.name())")
    ...
    @Mapping(target = "eventDataList.eventData.eventType", expression = "java(DboOperation.ELECTRONIC_CHEQUE.getEventType())")
    @Mapping(target = "eventDataList.eventData.eventDescription", expression = "java(DboOperation.ELECTRONIC_CHEQUE.getEventDescription())")
    @Mapping(target = "eventDataList.eventData.clientDefinedEventType", expression = "java(DboOperation.ELECTRONIC_CHEQUE.getClientDefinedEventType().name())")
    ...
    @Mapping(target = "channelIndicator", expression = "java(ChannelIndicator.WEB.name())")
    @Mapping(target = "clientDefinedChannelIndicator", expression = "java(ClientDefinedChannelIndicator.PPRB_BROWSER.name())")
